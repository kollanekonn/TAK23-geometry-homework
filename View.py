...
class View(Tk):
    def __init__(self, controller):
        ...
        self.title("Nelinurkse püramiidi GUI")
    ...
    def create_frame_widgets(self):
        bottom_side_label = Label(self.top_frame, text='Püramiidi põhiserv', font=self.default_font)
        bottom_side_label.grid(row=1, column=0, padx=5, pady=5)

        bottom_side_entry = Entry(self.top_frame, font=self.default_font)
        bottom_side_entry.grid(row=1, column=1, padx=5, pady=5)
        bottom_side_entry.focus()

        height_label = Label(self.top_frame, text='Püramiidi kõrgus', font=self.default_font)
        ...
        return bottom_side_entry, height_entry, btn_calculate, text_box
